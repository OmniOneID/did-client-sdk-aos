...
public interface WalletCoreInterface {
    ...
    void addOID4VCICredential(OID4VCICredential credential) throws WalletCoreException, UtilityException, WalletException;
    List<OID4VCICredential> getAllOID4VCICredentials() throws WalletCoreException, UtilityException, WalletException;
    List<OID4VCICredential> getOID4VCICredentials(List<String> identifiers) throws WalletCoreException, UtilityException, WalletException;
    void deleteOID4VCICredentials(List<String> identifiers) throws WalletCoreException, UtilityException, WalletException;
    boolean isAnyOID4VCICredentialsSaved() throws WalletException;
    ...
    List<KeyInfo> getKeyInfos(List<String> ids) throws WalletCoreException, UtilityException, WalletException;
