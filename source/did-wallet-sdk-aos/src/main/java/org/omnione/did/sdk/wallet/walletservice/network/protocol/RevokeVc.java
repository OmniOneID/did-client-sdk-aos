...
public class RevokeVc {
    ...
    public CompletableFuture<String> revokeVc(String url, String txId, String serverToken, ReqRevokeVC reqRevokeVc) {
        String api5 = "/api/v1/request-revoke-vc"; //VC revocation

        HttpUrlConnection httpUrlConnection = new HttpUrlConnection();

        return CompletableFuture.supplyAsync(() -> {
                    try {
                        return httpUrlConnection.send(url + api5, "POST", M220_RequestRevokeVcByWallet(txId, serverToken, reqRevokeVc));
